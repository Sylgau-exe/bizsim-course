    ...
    <div className="app">
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dashboard-page .nav-link-small { color: #6c757d; }
        ...
        .sidebar-section h3 { font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.1em; color: #6c757d; margin-bottom: 1rem; font-weight: 600; }
        .sidebar-btn { 
          width: 100%; 
        ...
        .score-date { font-size: 0.85rem; color: #6c757d; }
        .score-result { text-align: right; }
        .score-grade { font-size: 1.5rem; font-weight: 700; color: #b91425; margin-right: 0.75rem; }
        .score-points { color: #6c757d; font-weight: 500; }
        .no-scores { color: #6c757d; font-style: italic; }
        .featured-sim-card { 
        ...
        .featured-sim-content p { color: #6c757d; font-size: 0.9rem; margin-bottom: 0.5rem; }
        ...
        .sim-select-page .nav-link { color: #6c757d; }
        .sim-select-page .nav-link:hover { color: #1a1a2efff; }
        .sim-select-page .user-name { color: #6c757d; }
        ...
        .sim-select-page .sim-select-header p { color: #6c757d; font-size: 1.1rem; }
        ...
        .sim-select-header p { color: #6c757d; }
        ...
        .scenario-desc { color: #6c757d; font-size: 0.9rem; margin-bottom: 0.5rem; }
        ...
        .scenario-meta { text-align: right; font-size: 0.85rem; color: #6c757d; }
        ...
        .objective strong { font-size: 0.7rem; color: #6c757d; font-weight: 600; text-transform: uppercase; }
        ...
        .sim-playing .nav-link { color: #6c757d; }
        .sim-playing .nav-link:hover { color: #1a1a2efff; }
        .sim-playing .user-name { color: #6c757d; }
        ...
        .stat-status.neutral { color: #6c757d; }
        .stat-progress-bar {
          height: 6px;
          background: #dee2e6;
          border-radius: 3px;
        ...
        .quick-action-btn span:last-child { font-size: 0.75rem; color: #6c757d; }
        ...
        .status-item span { font-size: 0.85rem; color: #6c757d; }
        ...
        .timeline-panel h4 { font-size: 0.9rem; color: #6c757d; margin: 0; }
        .timeline-status {
          font-size: 0.75rem;
          font-weight: 500;
          color: #495057;
        ...
        .sim-playing .action-section h4 { font-size: 0.9rem; color: #6c757d; margin-bottom: 0.75rem; font-weight: 600; }
        ...
        .sim-playing .meeting-desc { font-size: 0.8rem; color: #6c757d; line-height: 1.4; }
        ...
        .end-card > p { color: #6c757d; margin-bottom: 2rem; }
        .score-display { margin-bottom: 2rem; }
        .grade { font-size: 6rem; font-weight: 800; line-height: 1; }
        .score { font-family: 'JetBrains Mono', monospace; font-size: 1.5rem; color: #6c757d; display: block; }
        ...
        .end-actions .btn-secondary { background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%); border: 1px solid #3a3a50; color: #495057; }
        ...
        .metric-badge.neutral { background: #212529; color: #6c757d; }
        ...
        .plan-badge.free { background: #212529; color: #6c757d; }
        ...
        .user-detail-header p { margin: 0; color: #6c757d; }
        ...
        .sub-item.free .sub-bar-fill { background: #868e96; }
        ...
        .txn-info span { font-size: 0.8rem; color: #6c757d; }
        .txn-amount {
          font-weight: 700;
          color: #10b981;
        }
        ...
        .resource-header span:first-child { color: #6c757d; }
