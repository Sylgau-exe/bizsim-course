...
const TRANSLATIONS = {
  ...
  results: {
    ...
    missionRecap: { en: 'Mission Recap', fr: 'Récapitulatif de la mission' },
    missionIntro: { en: 'Here\'s how you performed across the key project dimensions:', fr: 'Voici vos performances sur les dimensions clés du projet:' },
    scope: { en: 'SCOPE', fr: 'PÉRIMÈTRE' },
    schedule: { en: 'SCHEDULE', fr: 'CALENDRIER' },
    budget: { en: 'BUDGET', fr: 'BUDGET' },
    quality: { en: 'QUALITY', fr: 'QUALITÉ' },
    ...
    maintainQuality: { en: 'Maintain quality above B+', fr: 'Maintenir la qualité au-dessus de B+' },
    keepMorale: { en: 'Keep morale above 60%', fr: 'Maintenir le moral au-dessus de 60%' },
    onTime: { en: 'On time ✓', fr: 'Dans les temps ✓' },
    weeksOver: { en: 'weeks over deadline', fr: 'semaines de retard' },
    underBudget: { en: 'under budget', fr: 'sous le budget' },
    overBudget: { en: 'Over budget', fr: 'Dépassement budgétaire' },
    metStandard: { en: 'Met standard', fr: 'Standard atteint' },
    belowStandard: { en: 'Below standard', fr: 'Sous le standard' },
    teamHappy: { en: 'Team satisfied', fr: 'Équipe satisfaite' },
    teamBurnedOut: { en: 'Team burned out', fr: 'Équipe épuisée' },
    completedScope: { en: 'Completed scope', fr: 'Périmètre livré' },
    partial: { en: 'Partial delivery', fr: 'Livraison partielle' },
    deliveredOnTime: { en: 'Delivered on time', fr: 'Livré à temps' },
    daysLate: { en: 'days late', fr: 'jours de retard' },
    excellentBudget: { en: 'Excellent budget control', fr: 'Excellent contrôle budgétaire' },
    maintainedQuality: { en: 'Quality maintained', fr: 'Qualité maintenue' },
    keptMoraleHealthy: { en: 'Healthy team morale', fr: 'Moral d\'équipe sain' },
    lowMorale: { en: 'Low morale', fr: 'Moral bas' },
    goodMorale: { en: 'Good morale', fr: 'Bon moral' },
    scoreBreakdown: { en: 'Score Breakdown', fr: 'Détail du score' },
    performanceAnalysis: { en: 'Performance Analysis', fr: 'Analyse de performance' },
    whatWentWell: { en: 'What Went Well', fr: 'Points positifs' },
    areasForImprovement: { en: 'Areas for Improvement', fr: 'Points à améliorer' },
    achievements: { en: 'Achievements', fr: 'Réalisations' },
    pmProTips: { en: 'PM Pro Tips', fr: 'Conseils de pro en GP' },
    keyInsight: { en: 'Key Insight', fr: 'Point clé' },
    keyInsightA: { en: 'Outstanding performance! You balanced all project dimensions effectively.', fr: 'Performance exceptionnelle! Vous avez équilibré toutes les dimensions du projet.' },
    keyInsightB: { en: 'Good job! Focus on tightening the areas where you lost points.', fr: 'Bon travail! Concentrez-vous sur les domaines où vous avez perdu des points.' },
    keyInsightC: { en: 'Decent effort. Review your decision patterns — small changes compound.', fr: 'Effort correct. Revoyez vos décisions — les petits changements s\'accumulent.' },
    keyInsightD: { en: 'Challenging run. Consider pacing decisions and managing team stress.', fr: 'Partie difficile. Réfléchissez au rythme des décisions et au stress de l\'équipe.' },
    outstandingPerformance: { en: 'Outstanding Performance', fr: 'Performance exceptionnelle' },
    excellent: { en: 'Excellent', fr: 'Excellent' },
    veryGood: { en: 'Very Good', fr: 'Très bien' },
    needsWork: { en: 'Needs Improvement', fr: 'À améliorer' },
    playAgain: { en: 'Play Again', fr: 'Rejouer' },
    tryNewIndustry: { en: 'Try Different Scenario', fr: 'Essayer un autre scénario' },
    backToDashboard: { en: 'Back to Home', fr: 'Retour à l\'accueil' },
    printReport: { en: 'Print Report', fr: 'Imprimer le rapport' },
    copySummary: { en: 'Copy Summary', fr: 'Copier le résumé' },
    copiedToClipboard: { en: 'Copied to clipboard!', fr: 'Copié dans le presse-papiers!' },
    completedSimulation: { en: 'completed a simulation', fr: 'a terminé une simulation' },
    ironTriangle: { en: 'The Iron Triangle: scope, schedule, and budget are interconnected. Pushing one affects the others.', fr: 'Le triangle de fer: périmètre, calendrier et budget sont interconnectés.' },
    scopeTip: { en: 'Control scope early. Scope creep is the #1 PM challenge.', fr: 'Contrôlez le périmètre tôt. Le glissement de périmètre est le défi #1.' },
    scheduleTip: { en: 'Avoid changing the deadline repeatedly — it destroys team trust.', fr: 'Évitez de changer la date limite — cela détruit la confiance de l\'équipe.' },
    budgetTip: { en: 'Track burn rate weekly. Small overruns compound fast.', fr: 'Suivez le taux de dépenses chaque semaine.' },
    qualityTip: { en: 'Quality reviews cost time but prevent expensive rework.', fr: 'Les revues qualité coûtent du temps mais évitent des reprises coûteuses.' },
    teamTip: { en: 'Invest in coaching early — knowledge reduces mistakes.', fr: 'Investissez dans le coaching tôt — la connaissance réduit les erreurs.' },
    planningTip: { en: 'Good planning upfront prevents firefighting later.', fr: 'Une bonne planification évite les urgences.' },
    sustainablePace: { en: 'Sustainable pace beats crunch. High stress kills productivity.', fr: 'Un rythme durable bat le crunch. Le stress élevé tue la productivité.' },
    technicalDebt: { en: 'Address technical debt early before it becomes a crisis.', fr: 'Traitez la dette technique tôt avant qu\'elle ne devienne une crise.' },
    riskReduction: { en: 'Prototyping reduces risk. Build early, fail cheap.', fr: 'Le prototypage réduit les risques. Construisez tôt, échouez à moindre coût.' },
    minimalScheduleChanges: { en: 'Minimal schedule changes', fr: 'Changements de calendrier minimaux' },
    usedPrototyping: { en: 'Used prototyping effectively', fr: 'Prototypage utilisé efficacement' },
  }
};
      ...
      return (
        <div className="sim-select-page">
          ...
          <div className="sim-select-container">
            <button className="back-link" onClick={() => setCurrentPage('home')}>← {lang === 'en' ? 'Back to Home' : 'Retour à l\'accueil'}</button>
          ...
          <div className="game-layout">
            ...
            <div className="game-sidebar">
              <button className="sidebar-exit-btn" onClick={() => {
                if (confirm(lang === 'en' ? 'Exit simulation? Your progress will be lost.' : 'Quitter la simulation? Votre progression sera perdue.')) {
                  setGameState(null);
                ...
                ← {lang === 'en' ? 'Exit Simulation' : 'Quitter la simulation'}
              </button>
    ...
    <div className="app">
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sim-select-page .nav-link:hover { color: #1a1a2e; }
        .sim-select-page .user-name { color: #495057; }
        .sim-select-page .logo-text { color: #1a1a2e; }
        ...
        .sim-select-page .sim-select-header h1 { font-size: 2.5rem; font-weight: 700; color: #1a1a2e; margin-bottom: 0.5rem; }
        ...
        .sim-playing .nav-link:hover { color: #1a1a2e; }
        .sim-playing .user-name { color: #495057; }
        .sim-playing .logo-text { color: #1a1a2e; }
        ...
        .status-value { font-weight: 600; color: #1a1a2e !important; }
        ...
        .alert-card h4 { color: #1a1a2e; margin-bottom: 0.5rem; }
        ...
        .event-modal.enhanced {
          ...
          max-width: 600px;
          overflow: hidden;
          box-shadow: 0 25px 80px rgba(0,0,0,0.15), 0 0 40px rgba(239, 68, 68, 0.08);
        }
        .event-modal-header {
          padding: 1.5rem 2rem;
          text-align: center;
        ...
        .sim-playing .action-label { font-family: 'JetBrains Mono', monospace; font-weight: 700; min-width: 120px; text-align: center; color: #1a1a2e; }
        ...
        .sim-playing .meeting-name { font-weight: 700; font-size: 0.9rem; color: #1a1a2e; }
        ...
        .sim-playing .event-modal h2 { font-size: 1.5rem; margin-bottom: 0.75rem; color: #1a1a2e; }
        ...
        .end-card h1 { font-size: 1.75rem; margin-bottom: 0.25rem; color: #1a1a2e; }
